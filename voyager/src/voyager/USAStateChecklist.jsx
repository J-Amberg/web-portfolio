...
import { States} from './images';
import {Footer} from './Home';

export default function USAStateChecklist() {
  let stateNames = Object.keys(States); //get state names from the StateImages object
  //map the array to an array of objects and set false (for not visited)
  const [states, setStates] = useState(
    stateNames.reduce((stateName, state) => ({ ...stateName, [state]: false }), {}),
  );

  const onVisitedChange = (stateName) => {
    setStates({ ...states, [stateName]: !states[stateName] });
  };

  const [stateBeingHovered, setStateBeingHovered] = useState('');

  const getTextColor = (state) => {
    return states[state] ? { color: 'white' } : { color: 'black' };
  };
  const getProperClass = (state) => {
    return stateBeingHovered && states[state]
      ? 'notHoveredVisited'
      : stateBeingHovered && stateBeingHovered !== state
      ? 'notHoveredState'
      : states[state]
      ? 'visitedState'
      : stateBeingHovered === state
      ? 'hoveredState'
      : 'state';
  };

  //the count of visited & unvisited states
  ...
  return (
    <div className='h-[1850px]'>
      <div id='hero'>
        <div className='h1 mt-[66px]'>Track which states you've visited!</div>
        <div className='bodyText mt-[7px]'>
          {' '}
          Simply click on the states you've visited before to get started!
        </div>
      </div>
      <div className='relative h-[777px] w-[1423px] mt-[40px] ml-[-134px]' id='usa'>
        <div id='statepictures'>
          ...
          >
            ...
            />
            <defs id='defs4' style={{ fillRule: 'evenodd' }}></defs>
            ...
            <path
              ...
              onMouseEnter={() => setStateBeingHovered('Massachusetts')}
              onMouseLeave={() => setStateBeingHovered('')}
              onClick={() => onVisitedChange('Massachusetts')}
              className={getProperClass('Massachusetts')}
            />
            ...
            <path
              ...
              onMouseEnter={() => setStateBeingHovered('Minnesota')}
              onMouseLeave={() => setStateBeingHovered('')}
              onClick={() => onVisitedChange('Minnesota')}
              className={getProperClass('Minnesota')}
            />
            <path
              onMouseEnter={() => setStateBeingHovered('Montana')}
              onMouseLeave={() => setStateBeingHovered('')}
              onClick={() => onVisitedChange('Montana')}
              className={getProperClass('Montana')}
              inkscape:connector-curvature='0'
              id='Montana'
              data-name='Montana'
              data-id='Montana'
            ...
            <path
              inkscape:connector-curvature='0'
              onMouseEnter={() => setStateBeingHovered('North Dakota')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('North Dakota')}
              onClick={() => onVisitedChange('North Dakota')}
              id='North Dakota'
              data-name='North Dakota'
              data-id='North Dakota'
            ...
            <path
              ...
              onMouseEnter={() => setStateBeingHovered('Hawaii')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Hawaii')}
              onClick={() => onVisitedChange('Hawaii')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Idaho'
              ...
              onMouseEnter={() => setStateBeingHovered('Idaho')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Idaho')}
              onClick={() => onVisitedChange('Idaho')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Washington'
              ...
              onMouseEnter={() => setStateBeingHovered('Washington')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Washington')}
              onClick={() => onVisitedChange('Washington')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Arizona'
              ...
              onMouseEnter={() => setStateBeingHovered('Arizona')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Arizona')}
              onClick={() => onVisitedChange('Arizona')}
            />
            <path
              inkscape:connector-curvature='0'
              id='California'
              ...
              onMouseEnter={() => setStateBeingHovered('California')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('California')}
              onClick={() => onVisitedChange('California')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Colorado'
              ...
              onMouseEnter={() => setStateBeingHovered('Colorado')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Colorado')}
              onClick={() => onVisitedChange('Colorado')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Nevada'
              ...
              onMouseEnter={() => setStateBeingHovered('Nevada')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Nevada')}
              onClick={() => onVisitedChange('Nevada')}
            />
            <path
              inkscape:connector-curvature='0'
              id='New Mexico'
              ...
              onMouseEnter={() => setStateBeingHovered('New Mexico')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('New Mexico')}
              onClick={() => onVisitedChange('New Mexico')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Oregon'
              ...
              onMouseEnter={() => setStateBeingHovered('Oregon')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Oregon')}
              onClick={() => onVisitedChange('Oregon')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Utah'
              ...
              onMouseEnter={() => setStateBeingHovered('Utah')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Utah')}
              onClick={() => onVisitedChange('Utah')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Wyoming'
              ...
              onMouseEnter={() => setStateBeingHovered('Wyoming')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Wyoming')}
              onClick={() => onVisitedChange('Wyoming')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Arkansas'
              ...
              onMouseEnter={() => setStateBeingHovered('Arkansas')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Arkansas')}
              onClick={() => onVisitedChange('Arkansas')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Iowa'
              ...
              onMouseEnter={() => setStateBeingHovered('Iowa')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Iowa')}
              onClick={() => onVisitedChange('Iowa')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Kansas'
              ...
              onMouseEnter={() => setStateBeingHovered('Kansas')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Kansas')}
              onClick={() => onVisitedChange('Kansas')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Missouri'
              ...
              onMouseEnter={() => setStateBeingHovered('Missouri')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Missouri')}
              onClick={() => onVisitedChange('Missouri')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Nebraska'
              ...
              onMouseEnter={() => setStateBeingHovered('Nebraska')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Nebraska')}
              onClick={() => onVisitedChange('Nebraska')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Oklahoma'
              ...
              onMouseEnter={() => setStateBeingHovered('Oklahoma')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Oklahoma')}
              onClick={() => onVisitedChange('Oklahoma')}
            />
            <path
              inkscape:connector-curvature='0'
              id='South Dakota'
              data-name='South Dakota'
              data-id='South Dakota'
              ...
              onMouseEnter={() => setStateBeingHovered('South Dakota')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('South Dakota')}
              onClick={() => onVisitedChange('South Dakota')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Louisiana'
              ...
              onMouseEnter={() => setStateBeingHovered('Louisiana')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Louisiana')}
              onClick={() => onVisitedChange('Louisiana')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Texas'
              ...
              onMouseEnter={() => setStateBeingHovered('Texas')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Texas')}
              onClick={() => onVisitedChange('Texas')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Connecticut'
              ...
              onMouseEnter={() => setStateBeingHovered('Connecticut')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Connecticut')}
              onClick={() => onVisitedChange('Connecticut')}
            />
            <path
              inkscape:connector-curvature='0'
              id='New Hampshire'
              data-name='New Hampshire'
              data-id='New Hampshire'
              ...
              onMouseEnter={() => setStateBeingHovered('New Hampshire')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('New Hampshire')}
              onClick={() => onVisitedChange('New Hampshire')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Rhode Island'
              data-name='Rhode Island'
              data-id='Rhode Island'
              ...
              onMouseEnter={() => setStateBeingHovered('Rhode Island')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Rhode Island')}
              onClick={() => onVisitedChange('Rhode Island')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Vermont'
              ...
              onMouseEnter={() => setStateBeingHovered('Vermont')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Vermont')}
              onClick={() => onVisitedChange('Vermont')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Alabama'
              ...
              onMouseEnter={() => setStateBeingHovered('Alabama')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Alabama')}
              onClick={() => onVisitedChange('Alabama')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Florida'
              ...
              onMouseEnter={() => setStateBeingHovered('Florida')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Florida')}
              onClick={() => onVisitedChange('Florida')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Georgia'
              ...
              onMouseEnter={() => setStateBeingHovered('Georgia')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Georgia')}
              onClick={() => onVisitedChange('Georgia')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Mississippi'
              ...
              onMouseEnter={() => setStateBeingHovered('Mississippi')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Mississippi')}
              onClick={() => onVisitedChange('Mississippi')}
            />
            <path
              inkscape:connector-curvature='0'
              id='South Carolina'
              ...
              onMouseEnter={() => setStateBeingHovered('South Carolina')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('South Carolina')}
              onClick={() => onVisitedChange('South Carolina')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Illinois'
              ...
              onMouseEnter={() => setStateBeingHovered('Illinois')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Illinois')}
              onClick={() => onVisitedChange('Illinois')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Indiana'
              ...
              onMouseEnter={() => setStateBeingHovered('Indiana')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Indiana')}
              onClick={() => onVisitedChange('Indiana')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Kentucky'
              ...
              onMouseEnter={() => setStateBeingHovered('Kentucky')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Kentucky')}
              onClick={() => onVisitedChange('Kentucky')}
            />
            <path
              inkscape:connector-curvature='0'
              id='North Carolina'
              ...
              onMouseEnter={() => setStateBeingHovered('North Carolina')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('North Carolina')}
              onClick={() => onVisitedChange('North Carolina')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Ohio'
              ...
              onMouseEnter={() => setStateBeingHovered('Ohio')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Ohio')}
              onClick={() => onVisitedChange('Ohio')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Tennessee'
              ...
              onMouseEnter={() => setStateBeingHovered('Tennessee')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Tennessee')}
              onClick={() => onVisitedChange('Tennessee')}
            />
            <path
              inkscape:connector-curvature='0'
              onMouseEnter={() => setStateBeingHovered('Virginia')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Virginia')}
              onClick={() => onVisitedChange('Virginia')}
              id='Virginia'
              data-name='Virginia'
              data-id='Virginia'
            ...
            <path
              inkscape:connector-curvature='0'
              onMouseEnter={() => setStateBeingHovered('Wisconsin')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Wisconsin')}
              onClick={() => onVisitedChange('Wisconsin')}
              id='Wisconsin'
              data-name='Wisconsin'
              data-id='Wisconsin'
            ...
            <path
              ...
              onMouseEnter={() => setStateBeingHovered('West Virginia')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('West Virginia')}
              onClick={() => onVisitedChange('West Virginia')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Delaware'
              ...
              onMouseEnter={() => setStateBeingHovered('Delaware')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Delaware')}
              onClick={() => onVisitedChange('Delaware')}
            />
            <path
              inkscape:connector-curvature='0'
              id='DC'
              ...
              onMouseEnter={() => setStateBeingHovered('DC')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('DC')}
              onClick={() => onVisitedChange('DC')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Maryland'
              ...
              onMouseEnter={() => setStateBeingHovered('Maryland')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Maryland')}
              onClick={() => onVisitedChange('Maryland')}
            />
            <path
              inkscape:connector-curvature='0'
              id='New Jersey'
              ...
              onMouseEnter={() => setStateBeingHovered('New Jersey')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('New Jersey')}
              onClick={() => onVisitedChange('New Jersey')}
            />
            <path
              inkscape:connector-curvature='0'
              id='New York'
              ...
              onMouseEnter={() => setStateBeingHovered('New York')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('New York')}
              onClick={() => onVisitedChange('New York')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Pennsylvania'
              ...
              onMouseEnter={() => setStateBeingHovered('Pennsylvania')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Pennsylvania')}
              onClick={() => onVisitedChange('Pennsylvania')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Maine'
              ...
              onMouseEnter={() => setStateBeingHovered('Maine')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Maine')}
              onClick={() => onVisitedChange('Maine')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Michigan'
              ...
              onMouseEnter={() => setStateBeingHovered('Michigan')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Michigan')}
              onClick={() => onVisitedChange('Michigan')}
            />
            <path
              inkscape:connector-curvature='0'
              id='Alaska'
              ...
              onMouseEnter={() => setStateBeingHovered('Alaska')}
              onMouseLeave={() => setStateBeingHovered('')}
              className={getProperClass('Alaska')}
              onClick={() => onVisitedChange('Alaska')}
            />
            {/*use the use tag to bring the stateBeingHovered to the front*/}
            {/*stateBeingHovered && <use id='use' className='state' xlinkHref={'#' + stateBeingHovered}/>&*/}
          </svg>
        </div>
        <div id='statelabels'>
          <span
            className='stateAbbreviation left-[540px] top-[130px]'
            onMouseEnter={() => setStateBeingHovered('Montana')}
            style={getTextColor('Montana')}
            onClick={() => onVisitedChange('Montana')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
            MT
          ...
          <span
            className='stateAbbreviation left-[335px] top-[80px]'
            style={getTextColor('Washington')}
            onClick={() => onVisitedChange('Washington')}
            onMouseEnter={() => setStateBeingHovered('Washington')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[300px] top-[180px]'
            style={getTextColor('Oregon')}
            onClick={() => onVisitedChange('Oregon')}
            onMouseEnter={() => setStateBeingHovered('Oregon')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[260px] top-[370px]'
            style={getTextColor('California')}
            onClick={() => onVisitedChange('California')}
            onMouseEnter={() => setStateBeingHovered('California')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[350px] top-[320px]'
            style={getTextColor('Nevada')}
            onClick={() => onVisitedChange('Nevada')}
            onMouseEnter={() => setStateBeingHovered('Nevada')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[420px] top-[210px]'
            style={getTextColor('Idaho')}
            onClick={() => onVisitedChange('Idaho')}
            onMouseEnter={() => setStateBeingHovered('Idaho')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[710px] top-[130px]'
            style={getTextColor('North Dakota')}
            onClick={() => onVisitedChange('North Dakota')}
            onMouseEnter={() => setStateBeingHovered('North Dakota')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[555px] top-[250px]'
            style={getTextColor('Wyoming')}
            onClick={() => onVisitedChange('Wyoming')}
            onMouseEnter={() => setStateBeingHovered('Wyoming')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[460px] top-[350px]'
            style={getTextColor('Utah')}
            onClick={() => onVisitedChange('Utah')}
            onMouseEnter={() => setStateBeingHovered('Utah')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[590px] top-[370px]'
            style={getTextColor('Colorado')}
            onClick={() => onVisitedChange('Colorado')}
            onMouseEnter={() => setStateBeingHovered('Colorado')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[440px] top-[490px]'
            style={getTextColor('Arizona')}
            onClick={() => onVisitedChange('Arizona')}
            onMouseEnter={() => setStateBeingHovered('Arizona')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[580px] top-[500px]'
            style={getTextColor('New Mexico')}
            onClick={() => onVisitedChange('New Mexico')}
            onMouseEnter={() => setStateBeingHovered('New Mexico')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[750px] top-[600px]'
            style={getTextColor('Texas')}
            onClick={() => onVisitedChange('Texas')}
            onMouseEnter={() => setStateBeingHovered('Texas')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[780px] top-[470px]'
            style={getTextColor('Oklahoma')}
            onClick={() => onVisitedChange('Oklahoma')}
            onMouseEnter={() => setStateBeingHovered('Oklahoma')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[760px] top-[390px]'
            style={getTextColor('Kansas')}
            onClick={() => onVisitedChange('Kansas')}
            onMouseEnter={() => setStateBeingHovered('Kansas')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[720px] top-[300px]'
            style={getTextColor('Nebraska')}
            onClick={() => onVisitedChange('Nebraska')}
            onMouseEnter={() => setStateBeingHovered('Nebraska')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[720px] top-[215px]'
            style={getTextColor('South Dakota')}
            onClick={() => onVisitedChange('South Dakota')}
            onMouseEnter={() => setStateBeingHovered('South Dakota')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[820px] top-[160px]'
            style={getTextColor('Minnesota')}
            onClick={() => onVisitedChange('Minnesota')}
            onMouseEnter={() => setStateBeingHovered('Minnesota')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[860px] top-[280px]'
            style={getTextColor('Iowa')}
            onClick={() => onVisitedChange('Iowa')}
            onMouseEnter={() => setStateBeingHovered('Iowa')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[880px] top-[380px]'
            style={getTextColor('Missouri')}
            onClick={() => onVisitedChange('Missouri')}
            onMouseEnter={() => setStateBeingHovered('Missouri')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[900px] top-[485px]'
            style={getTextColor('Arkansas')}
            onClick={() => onVisitedChange('Arkansas')}
            onMouseEnter={() => setStateBeingHovered('Arkansas')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[900px] top-[570px]'
            style={getTextColor('Louisiana')}
            onClick={() => onVisitedChange('Louisiana')}
            onMouseEnter={() => setStateBeingHovered('Louisiana')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[965px] top-[540px]'
            style={getTextColor('Mississippi')}
            onClick={() => onVisitedChange('Mississippi')}
            onMouseEnter={() => setStateBeingHovered('Mississippi')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[932px] top-[210px]'
            style={getTextColor('Wisconsin')}
            onClick={() => onVisitedChange('Wisconsin')}
            onMouseEnter={() => setStateBeingHovered('Wisconsin')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[960px] top-[330px]'
            style={getTextColor('Illinois')}
            onClick={() => onVisitedChange('Illinois')}
            onMouseEnter={() => setStateBeingHovered('Illinois')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[1030px] top-[330px]'
            style={getTextColor('Indiana')}
            onClick={() => onVisitedChange('Indiana')}
            onMouseEnter={() => setStateBeingHovered('Indiana')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[1040px] top-[230px]'
            style={getTextColor('Michigan')}
            onClick={() => onVisitedChange('Michigan')}
            onMouseEnter={() => setStateBeingHovered('Indiana')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[1090px] top-[295px]'
            style={getTextColor('Ohio')}
            onClick={() => onVisitedChange('Ohio')}
            onMouseEnter={() => setStateBeingHovered('Ohio')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[1075px] top-[380px]'
            style={getTextColor('Kentucky')}
            onClick={() => onVisitedChange('Kentucky')}
            onMouseEnter={() => setStateBeingHovered('Kentucky')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[1040px] top-[440px]'
            style={getTextColor('Tennessee')}
            onClick={() => onVisitedChange('Tennessee')}
            onMouseEnter={() => setStateBeingHovered('Tennessee')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[1050px] top-[530px]'
            style={getTextColor('Alabama')}
            onClick={() => onVisitedChange('Alabama')}
            onMouseEnter={() => setStateBeingHovered('Alabama')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[1120px] top-[520px]'
            style={getTextColor('Georgia')}
            onClick={() => onVisitedChange('Georgia')}
            onMouseEnter={() => setStateBeingHovered('Georgia')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[1200px] top-[640px]'
            style={getTextColor('Florida')}
            onClick={() => onVisitedChange('Florida')}
            onMouseEnter={() => setStateBeingHovered('Florida')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[1180px] top-[470px]'
            style={getTextColor('South Carolina')}
            onClick={() => onVisitedChange('South Carolina')}
            onMouseEnter={() => setStateBeingHovered('South Carolina')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[1210px] top-[410px]'
            style={getTextColor('North Carolina')}
            onClick={() => onVisitedChange('North Carolina')}
            onMouseEnter={() => setStateBeingHovered('North Carolina')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[1210px] top-[350px]'
            style={getTextColor('Virginia')}
            onClick={() => onVisitedChange('Virginia')}
            onMouseEnter={() => setStateBeingHovered('Virginia')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[1148px] top-[342px] text-[30px]'
            style={getTextColor('West Virginia')}
            onClick={() => onVisitedChange('West Virginia')}
            onMouseEnter={() => setStateBeingHovered('West Virginia')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[1200px] top-[255px]'
            style={getTextColor('Pennsylvania')}
            onClick={() => onVisitedChange('Pennsylvania')}
            onMouseEnter={() => setStateBeingHovered('Pennsylvania')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[1235px] top-[180px]'
            style={getTextColor('New York')}
            onClick={() => onVisitedChange('New York')}
            onMouseEnter={() => setStateBeingHovered('New York')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[1325px] top-[75px]'
            style={getTextColor('Maine')}
            onClick={() => onVisitedChange('Maine')}
            onMouseEnter={() => setStateBeingHovered('Maine')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span
            className='stateAbbreviation left-[290px] top-[670px]'
            style={getTextColor('Alaska')}
            onClick={() => onVisitedChange('Alaska')}
            onMouseEnter={() => setStateBeingHovered('Alaska')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span className='stateLine left-[555px] top-[750px] w-[40px] rotate-[171deg]'></span>
          <span
            className='stateAbbreviation  left-[510px] top-[740px]'
            style={getTextColor('Hawaii')}
            onClick={() => onVisitedChange('Hawaii')}
            onMouseEnter={() => setStateBeingHovered('Hawaii')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span className='stateLine left-[1250px] top-[335px] w-[64px] rotate-[-141deg]'></span>
          <span
            className='stateAbbreviation  left-[1310px] top-[340px]'
            style={getTextColor('Maryland')}
            onClick={() => onVisitedChange('Maryland')}
            onMouseEnter={() => setStateBeingHovered('Maryland')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span className='stateLine left-[1285px] top-[320px] w-[44px] rotate-[-167deg]'></span>
          <span
            className='stateAbbreviation  left-[1330px] top-[305px]'
            style={getTextColor('Delaware')}
            onClick={() => onVisitedChange('Delaware')}
            onMouseEnter={() => setStateBeingHovered('Delaware')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span className='stateLine left-[1295px] top-[280px] w-[34px] rotate-[178deg]'></span>
          <span
            className='stateAbbreviation  left-[1332px] top-[260px]'
            style={getTextColor('New Jersey')}
            onClick={() => onVisitedChange('New Jersey')}
            onMouseEnter={() => setStateBeingHovered('New Jersey')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span className='stateLine left-[1320px] top-[226px] w-[36px] rotate-[-149deg]'></span>
          <span
            className='stateAbbreviation  left-[1360px] top-[220px]'
            style={getTextColor('Connecticut')}
            onClick={() => onVisitedChange('Connecticut')}
            onMouseEnter={() => setStateBeingHovered('Connecticut')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span className='stateLine left-[1342px] top-[212px] w-[34px] rotate-[169deg]'></span>
          <span
            className='stateAbbreviation  left-[1380px] top-[187px]'
            style={getTextColor('Rhode Island')}
            onClick={() => onVisitedChange('Rhode Island')}
            onMouseEnter={() => setStateBeingHovered('Rhode Island')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span className='stateLine left-[1330px] top-[182px] w-[45px] rotate-[144deg]'></span>
          <span
            className='stateAbbreviation  left-[1380px] top-[145px]'
            style={getTextColor('Massachusetts')}
            onClick={() => onVisitedChange('Massachusetts')}
            onMouseEnter={() => setStateBeingHovered('Massachusetts')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span className='stateLine left-[1240px] top-[130px] w-[61px] rotate-[-143deg]'></span>
          <span
            className='stateAbbreviation  left-[1200px] top-[89px]'
            style={getTextColor('Vermont')}
            onClick={() => onVisitedChange('Vermont')}
            onMouseEnter={() => setStateBeingHovered('Vermont')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
          ...
          <span className='stateLine left-[1275px] top-[125px] w-[62px] rotate-[-117deg]'></span>
          <span
            className='stateAbbreviation  left-[1265px] top-[60px]'
            style={getTextColor('New Hampshire')}
            onClick={() => onVisitedChange('New Hampshire')}
            onMouseEnter={() => setStateBeingHovered('New Hampshire')}
            onMouseLeave={() => setStateBeingHovered('')}
          >
      ...
      <div className='grid grid-cols-2 gap-10 mt-[50px] w-[100%] '>
        {/*Visited*/}
        <div className='col-span-1'>
          <span className='sectionHeader capitalize underline'>Visited</span>
          <span className='sectionHeader'>({visitedCount})</span>
          <div className='columns-3 mt-[30px]'>
            {stateNames.map(stateName => {
                return states[stateName] && <div key={stateName} className='bodyText'>{stateName}</div>
            })}
          </div>
        </div>
        <div className='col-span-1'>
          <span className='sectionHeader capitalize underline'>Yet To Visit</span>
          <span className='sectionHeader'>({50 - visitedCount})</span>
          <div className='columns-3 mt-[30px]'>
            {stateNames.map(stateName => {
                return !states[stateName] && <div className='bodyText' key={stateName}>{stateName}</div>
            })}
          </div>
        </div>
      </div>

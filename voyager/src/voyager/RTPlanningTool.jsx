...
export default function RTPlanningTool({margin}) {
  
  //to keep the pins where they are if the window is resized
  const [lastMargin, setLastMargin] = useState(margin);
  useEffect(() => {
    setLastMargin(margin)
  }, [margin])
  const [pins, setPins] = useState([]);

  const addPin = (event, state) => {
    if(pins.length >= 20){
      return;
    }
    const pin = {
    ...
    let pinsCopy = JSON.parse(JSON.stringify(pins));
    pinsCopy[pins.length] = pin;
    setPins(pinsCopy);
  }
  ...
  useEffect(() => {
    if(!pins)
      return
    let tempPins = pins.map(pin => {
      return {
        ...pin,
        'pinX': pin.pinX - (lastMargin - margin)
      }
    })
    setPins(tempPins)
  }, [margin])
  
  const [pinLines, setPinLines] = useState([]);

  useEffect(() => {
    //only draw lines if 2 or more pins
    if(pins.length <= 1 && pinLines != []){
      setPinLines([]);
    }
    ...
    for(let i = 0; i < pins.length; i++){
      if(i !== 0){    
        var x1 = lastPinX + 12;
        var y1 = lastPinY + 50;
        var x2 = pins[i].pinX + 12;
        var y2 = pins[i].pinY + 50;
        // distance
        ...
        tempPinLines[i - 1] = line;
      }
      lastPinY = pins[i].pinY;
      lastPinX = pins[i].pinX;
    }
    setPinLines(tempPinLines);
  }, [pins])
  ...
  return <div >
    {pins &&
    <div id='pins' className='h-[0px] w-[0px]'>
      {pins.map((pin, index) => {
        return <div key={index}>
          <img src={Pin} className='pointer-events-none absolute z-50 h-[50px] w-auto' style={{left:`${pin.pinX}px`, top: `${pin.pinY}px`}} alt='pin'/>
          <div className='pointer-events-none absolute text-5xl z-[50] text-white' style={index < 9 ? {left:`${pin.pinX-25}px`, top: `${pin.pinY}px`} : {left:`${pin.pinX-45}px`, top: `${pin.pinY}px`}  }>{index + 1}</div>
        </div>
      })}
    </div>}
    {pinLines &&
      <div id='pinlines' className='h-[0px] w-[0px]'>
        {pinLines.map((line, index) => {
           //var htmlLine = "<div style='padding:0px; margin:0px; height:" + thickness + "px; background-color:" + color + "; line-height:1px; position:absolute; left:" + cx + "px; top:" + cy + "px; width:" + length + "px; -moz-transform:rotate(" + angle + "deg); -webkit-transform:rotate(" + angle + "deg); -o-transform:rotate(" + angle + "deg); -ms-transform:rotate(" + angle + "deg); transform:rotate(" + angle + "deg);' />";
          return <div className='pointer-events-none absolute leading-[1px] border-2 border-dashed border-forestgreen m-0 p-0 h-[0px] z-30' key={index} 
            style={{left:`${line.left}px`, top: `${line.top}px`, width:`${line.length}px`, transform:`rotate(${line.angle}deg)`}}>
          </div>
        })}
      </div>
    }
    <div id='hero' className='w-[1231px] h-[426px]'>
      <div id='sunOuter' style={{left:`${margin+84}px`, top:'206px'}}></div>
      <div id='sun' style={{left:`${margin+169}px`, top:'292px'}}></div>
      <div id='sunInner' style={{left:`${margin+242}px`, top:'364px'}}></div>
      <div className='h1 w-[634px] text-right absolute top-[220px]' style={{left:`${margin+677}px`}}>
        It's never been easier to plan a road trip 
      </div>
      <div className='bodyText w-[644px] absolute text-right h-[117px] top-[456px]' style={{left:`${margin+671}px`}}>
      Pin the locations you'd like to go and we'll send you a suggested itinerary as well as additional activities to do in the areas. 
      </div>
    </div>
    <div className='relative h-[777px] w-[1423px] mt-[110px] ml-[-134px]' id='usa'>
        <div id='statepictures'>
          ...
          >
            ...
            <path
              ...
              onClick={(event) => addPin(event, 'Massachusetts')}
              id='Massachusetts'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Minnesota')}
              id='Minnesota'
              data-name='Minnesota'
              data-id='Minnesota'
            ...
            <path
              className='state'
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Montana')}
              id='Montana'
              data-name='Montana'
              data-id='Montana'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'North Dakota')}
              className='state'
              id='North Dakota'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Hawaii')}
              id='Hawaii'
              data-name='Hawaii'
              data-id='Hawaii'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Idaho')}
              id='Idaho'
              data-name='Idaho'
              data-id='Idaho'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Washington')}
              id='Washington'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Arizona')}
              id='Arizona'
              data-name='Arizona'
              data-id='Arizona'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'California')}
              id='California'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Colorado')}
              id='Colorado'
              data-name='Colorado'
              data-id='Colorado'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Nevada')}
              id='Nevada'
              data-name='Nevada'
              data-id='Nevada'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'New Mexico')}
              id='New Mexico'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Oregon')}
              id='Oregon'
              data-name='Oregon'
              data-id='Oregon'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Utah')}
              id='Utah'
              data-name='Utah'
              data-id='Utah'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Wyoming')}
              id='Wyoming'
              data-name='Wyoming'
              data-id='Wyoming'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Arkansas')}
              id='Arkansas'
              data-name='Arkansas'
              data-id='Arkansas'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Iowa')}
              id='Iowa'
              data-name='Iowa'
              data-id='Iowa'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Kansas')}
              id='Kansas'
              data-name='Kansas'
              data-id='Kansas'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Missouri')}
              id='Missouri'
              data-name='Missouri'
              data-id='Missouri'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Nebraska')}
              id='Nebraska'
              data-name='Nebraska'
              data-id='Nebraska'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Oklahoma')}
              id='Oklahoma'
              data-name='Oklahoma'
              data-id='Oklahoma'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'South Dakota')}
              id='South Dakota'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Louisiana')}
              id='Louisiana'
              data-name='Louisiana'
              data-id='Louisiana'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Texas')}
              id='Texas'
              data-name='Texas'
              data-id='Texas'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Connecticut')}
              id='Connecticut'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'New Hampshire')}
              id='New Hampshire'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Rhode Island')}
              id='Rhode Island'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Vermont')}
              id='Vermont'
              data-name='Vermont'
              data-id='Vermont'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Alabama')}
              id='Alabama'
              data-name='Alabama'
              data-id='Alabama'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Florida')}
              id='Florida'
              data-name='Florida'
              data-id='Florida'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Georgia')}
              id='Georgia'
              data-name='Georgia'
              data-id='Georgia'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Mississippi')}
              id='Mississippi'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'South Carolina')}
              id='South Carolina'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Illinois')}
              id='Illinois'
              data-name='Illinois'
              data-id='Illinois'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Indiana')}
              id='Indiana'
              data-name='Indiana'
              data-id='Indiana'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Kentucky')}
              id='Kentucky'
              data-name='Kentucky'
              data-id='Kentucky'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'North Carolina')}
              id='North Carolina'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Ohio')}
              id='Ohio'
              data-name='Ohio'
              data-id='Ohio'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Tennessee')}
              id='Tennessee'
              data-name='Tennessee'
              data-id='Tennessee'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Virginia')}
              className='state'
              id='Virginia'
              data-name='Virginia'
              data-id='Virginia'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Wisconsin')}
              className='state'
              id='Wisconsin'
              data-name='Wisconsin'
              data-id='Wisconsin'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'West Virginia')}
              id='West Virginia'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Delaware')}
              id='Delaware'
              data-name='Delaware'
              data-id='Delaware'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Maryland')}
              id='Maryland'
              data-name='Maryland'
              data-id='Maryland'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'New Jersey')}
              id='New Jersey'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'New York')}
              id='New York'
              data-name='New York'
              data-id='New York'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Pennsylvania')}
              id='Pennsylvania'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Maine')}
              id='Maine'
              data-name='Maine'
              data-id='Maine'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Michigan')}
              id='Michigan'
              data-name='Michigan'
              data-id='Michigan'
            ...
            <path
              inkscape:connector-curvature='0'
              onClick={(event) => addPin(event, 'Alaska')}
              id='Alaska'
              data-name='Alaska'
              data-id='Alaska'
        ...
        <div id='statelabels' className='pointer-events-none'>
          <span
      ...
      {showRocket && 
        <img className='absolute' id='rocket' src={Rocket} />
      }
      <div id={showRocket && 'moon'} className='absolute top-[1300px] cursor-pointer' style={{left:`${margin+850}px`}} onClick={() => handleMoonClick()}>
        <div id='moonOuter'></div>
        <div id='moonInner' className='top-[11px] left-[11px]'></div>
        <div id='crater1' className='top-[32px] left-[82px]'></div>
        <div id='crater2' className='top-[73px] left-[36px]'></div>
        <div id='crater3' className='top-[113px] left-[26px]'></div>
        <div id='crater4' className='top-[128px] left-[64px]'></div>
        <div id='crater5' className='top-[136px] left-[144px]'></div>
        <div id='crater6' className='left-[130px] top-[73px]'></div>
      </div>
      <div id='pinsText' className='w-auto text-center top-[100px] relative min-h-[400px] '>
        <div className='h2'>Pins</div>
        {pins && <div className='grid grid-cols-3 gap-2'>
          {pins.map((pin, index) => {
            return <div className='bodyText mt-[20px] left' key={index}>{index+1}. {pin.state}</div>
          })}
        </div>}
        {pins.length > 3 && 
        <div id='submitButton' className='' onClick={() => setPins([])}><span className='w-[256px]'>Submit</span></div>}
      </div>
      <Footer top={150}/>
  </div>
}

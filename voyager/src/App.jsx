...
function App() {
  ...
  return <div>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com"/>
    <link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="true"/>
    <link href="https://fonts.googleapis.com/css2?family=Enriqueta:wght@400;500;600;700&display=swap" rel="stylesheet"></link>
    <div style={containerStyle}>
      {/*Navbar*/}
      <div className='navText mt-[33px]'> 
        <span className='mr-[360px]'>VOYAGER</span>
        <span className='mr-[80px]' style={selectedTab === 'home' ? selectedStyle : {}} onClick={() => setSelectedTab('home')}>Home</span>
        <span className='mr-[80px]' style={selectedTab === 'RTPlanningTool' ? selectedStyle : {}} onClick={() => setSelectedTab('RTPlanningTool')}>Road Trip Planning Tool</span>
        <span style={selectedTab === 'USAStateChecklist' ? selectedStyle : {}} onClick={() => setSelectedTab('USAStateChecklist')}>USA State Checklist</span>
      </div>
      {selectedTab === 'home' && <Home/>}
      {selectedTab === 'RTPlanningTool' && <RTPlanningTool/>}

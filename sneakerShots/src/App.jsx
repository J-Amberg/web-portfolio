...
function App() {
  ...
  const scrollToAbout = () => { //view scrolls to about section
    document.getElementById('aboutSection').scrollIntoView();
  }

  const scrollToPackages = () => { //view scrolls to packages section
    document.getElementById('packagesSection').scrollIntoView();
  }

  const scrollToTestimonials = () => { //view scrolls to testimonial section
    ...
    <div id="background">
      ...
      <div className='container' style={containerStyle}>
        <div className='karla yellowText'>
          ...
          <span className='navbarHeader' onClick={scrollToTestimonials}>Testimonials</span>
          <span className='navbarHeader' style={{marginRight:'82px'}} onClick={scrollToPackages}>Packages</span>
          <span className='navbarHeader' style={{marginRight:'82px'}} onClick={scrollToAbout}>About</span>
        </div>
        ...
        <div id='packagesSection'>
          ...
          <div id='footer'>
            ...
            <div className='bodyText yellowText karla' style={{position:'absolute', left:'239px', top: '40px', cursor:'pointer'}}>About</div>
            <div className='bodyText yellowText karla' style={{position:'absolute', left:'419px', top: '40px', cursor:'pointer'}}>Email</div>
            <div className='bodyText yellowText karla' style={{position:'absolute', left:'600px', top: '40px', cursor:'pointer'}}>Cleansing</div>
            <div className='bodyText yellowText karla' style={{position:'absolute', left:'419px', top: '80px', cursor:'pointer'}}>Twitter</div>
            <div className='bodyText yellowText karla' style={{position:'absolute', left:'600px', top: '80px', cursor:'pointer'}}>Authentication</div>
            <div className='bodyText yellowText karla' style={{position:'absolute', left:'419px', top: '120px',cursor:'pointer'}}>Instagram</div>
            <div className='bodyText yellowText karla' style={{position:'absolute', left:'600px', top: '120px',  cursor:'pointer'}}>Customization</div>
          </div>
        </div>
      </div>
      <div id='footerBar'/>
